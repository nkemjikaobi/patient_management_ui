...
const PatientDetails = ({ route, navigation }) => {
	...
	const fetchPatientDetails = async id => {
		...
		await fetch(
			`https://patient-management-system-api.onrender.com/patients/${id}`
		)
		...
		<>
			...
			<View style={{ padding: 20 }}>
				...
				<View style={styles.admission_status}>
					...
					<Text>{patient?.isAdmitted ? 'Admitted' : 'Not Admitted'}</Text>
				</View>
				...
				<PatientDetailsSections navigation={navigation} patient={patient} />
			</View>
			{/* )} */}
		</>
	);
